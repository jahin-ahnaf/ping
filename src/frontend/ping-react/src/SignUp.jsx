    ...
    return (
        <div>
            ...
            <form className="w-auto mx-auto sm:w-auto absolute left-8 right-8 text-center my-32 sm:my-64 p-10 center justify-center align-middle">
                <h1 className="text-2xl sm:text-3xl font-bold mb-8">Sign up to get started</h1>

                <div className="flex flex-col sm:flex-row gap-3 sm:w-[400px] w-[250px] mx-auto">
                    <input
                        type="text"
                ...
                {error && (
                    <p className="text-red-500 text-sm mt-2 sm:w-[400px] w-[250px] mx-auto text-left">{error}</p>
                )}
                ...
                {confirmError && (
                    <p className="text-red-500 text-sm mt-2 sm:w-[400px] w-[250px] mx-auto text-left">{confirmError}</p>
                )}

                <button type="submit" className="text-black hover:text-white mt-8 bg-cyan-500 sm:w-[400px] w-[250px] p-3 rounded-full font-semibold hover:bg-cyan-600 duration-300">Sign Up</button>
            </form>

            <p className="absolute bottom-0 left-0 right-0 text-center mb-4 sm:mb-8">
                Already have an account? <a href="/signin" className="text-cyan-900 font-semibold hover:underline cursor-pointer">Sign In</a>
            </p>
        </div>
    )
}
